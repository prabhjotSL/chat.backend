...
var services = [
  ...
  { _id : 31, name : "T1 Documents Received - Identity Document", type : "Documents, Grants and Status", role : "Home Care Volunteer" },
  { _id : 32, name : "T2 Documents Received - Birth Certificate", type : "Documents, Grants and Status", role : "Home Care Volunteer" },
  ...
  { _id : 42, name : "HB2- Regular Nose Bleed", type : "Symptoms", role : "Lay Counsellor" },
  { _id : 43, name : "HB4- Significant Weight Loss", type : "Symptoms", role : "Lay Counsellor" },
  { _id : 44, name : "HB4- Poor Appetite", type : "Symptoms", role : "Lay Counsellor" },
  { _id : 45, name : "HB5- Persistent Diarrhoea", type : "Symptoms", role : "Lay Counsellor" },
  { _id : 46, name : "HB6- Skin Rashes", type : "Symptoms", role : "Lay Counsellor" },
  { _id : 47, name : "HB7- Regular & Severe Headaches", type : "Symptoms", role : "Lay Counsellor" },
  { _id : 48, name : "HB8- Persistent Tiredness", type : "Symptoms", role : "Lay Counsellor" },
  { _id : 49, name : "HB9- Night Sweats", type : "Symptoms", role : "Lay Counsellor" },
  { _id : 50, name : "HB10- Regular Coughing (for more than 3 weeks)", type : "Symptoms", role : "Lay Counsellor" },
  { _id : 51, name : "HB11- Regular Coughing (for more than 24 hrs if HIV+)", type : "Symptoms", role : "Lay Counsellor" },
  { _id : 52, name : "HB12- Coughing up spit with blood", type : "Symptoms", role : "Lay Counsellor" },
  { _id : 53, name : "HB15- Swelling Of Limbs", type : "Symptoms", role : "Lay Counsellor" },
  { _id : 54, name : "HC1- TB", type : "Illnesses", role : "Lay Counsellor" },
  { _id : 55, name : "HC1B – Previously tested for HIV (NO=N YES = Y)", type : "Illnesses", role : "Lay Counsellor" },
  { _id : 56, name : "HC2- HIV+ But Not On ARV’s", type : "Illnesses", role : "Lay Counsellor" },
  { _id : 57, name : "HC5- HIV+ And On ARV’s", type : "Illnesses", role : "Lay Counsellor" },
  { _id : 58, name : "HC4-1Blood Sugar", type : "Illnesses", role : "Lay Counsellor" },
  { _id : 59, name : "HC5- High or Low Blood Pressure", type : "Illnesses", role : "Lay Counsellor" },
  { _id : 60, name : "HC6- Arthritis", type : "Illnesses", role : "Lay Counsellor" },
  { _id : 61, name : "HC7- Asthma", type : "Illnesses", role : "Lay Counsellor" },
  { _id : 62, name : "HC8- Heart Disease / Disorders", type : "Illnesses", role : "Lay Counsellor" },
  { _id : 63, name : "HC9- Kidney Diseases / Disorders", type : "Illnesses", role : "Lay Counsellor" },
  { _id : 64, name : "HC10- Stiff Joints (Gout)", type : "Illnesses", role : "Lay Counsellor" },
  { _id : 65, name : "HC11- Ulcers", type : "Illnesses", role : "Lay Counsellor" },
  { _id : 66, name : "HC12- Pregnancy / Child Birth", type : "Illnesses", role : "Lay Counsellor" },
  { _id : 67, name : "HE1- Physical Health Assessment Completed", type : "Testing and Education", role : "Lay Counsellor" },
  { _id : 68, name : "HE2- BP Screening & Testing Completed", type : "Testing and Education", role : "Lay Counsellor" },
  { _id : 69, name : "HE6- Sugar screening & testing Completed", type : "Testing and Education", role : "Lay Counsellor" },
  { _id : 70, name : "HE4- General Health Education Completed", type : "Testing and Education", role : "Lay Counsellor" },
  { _id : 71, name : "HE5- MMC Education Completed", type : "Testing and Education", role : "Lay Counsellor" },
  { _id : 72, name : "HE6- SRH Education Completed", type : "Testing and Education", role : "Lay Counsellor" },
  { _id : 73, name : "HE7- PMTCT Education Completed", type : "Testing and Education", role : "Lay Counsellor" },
  { _id : 74, name : "HE8- HIV Counselling & Testing Offered (if declined ASK *)", type : "Testing and Education", role : "Lay Counsellor" },
  { _id : 75, name : "HE9- Pre-Test Counselling Completed (Individuals)", type : "Testing and Education", role : "Lay Counsellor" },
  ...
  { _id : 83, name : "HE17- Referral To Support Group", type : "Referrals", role : "Lay Counsellor" },
  { _id : 84, name : "HE18- Referral For TB Screening", type : "Referrals", role : "Lay Counsellor" },
  { _id : 85, name : "HE19- Referral For MMC", type : "Referrals", role : "Lay Counsellor" },
  { _id : 86, name : "HE20- Referral For SRH", type : "Referrals", role : "Lay Counsellor" },
  { _id : 87, name : "HE21- Referral For PMTCT", type : "Referrals", role : "Lay Counsellor" },
  { _id : 88, name : "HE22- Referral for BP/Sugar or Other general health Concerns", type : "Referrals", role : "Lay Counsellor" },
